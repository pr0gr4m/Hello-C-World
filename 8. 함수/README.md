...
재귀 함수를 처음 학습하면 상세하게 이해하기 어려운데 정작 상용 서비스에는 사용을 지양해야 하기 때문에 동작 방식만 간단하게 소개하는 경우도 있다. 하지만 확실하게 학습하고 나면 일반적인 함수의 동작 원리까지 더욱 깊게 이해할 수 있기 때문에 해당 서적에서는 분량을 꽤나 투자했다. 이번에도 학습을 마친 독자분들에게 격려의 말을 남긴다.  
